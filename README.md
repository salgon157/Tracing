...
| **`_baseline_*/`** | ⛔ **ARCHIV — NESAHAT.** git worktree se starým solverem (strana A regresního A/B, `regression_ab.py`). Mimo projekt, gitignored, needituje se a nespouští se odsud ostrý běh. Viz `_NESAHAT_ARCHIV.md` uvnitř. |
